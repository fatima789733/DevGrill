...
export default function HoverButton({
  ...
  return (
    <button
      className={`
        relative flex overflow-hidden cursor-pointer w-[200px] h-[50px] 
        bg-gray-200 rounded-[80px] border-none px-24
    ...
    >
      ...
      <span
        className={`
          absolute z-[99] w-[200px] h-[50px] rounded-[80px] 
          font-semibold text-center leading-[50px] 
          tracking-[0px] text-gray-200 bg-gray-900 px-2.5
          transition-all duration-[1200ms] ease-in-out flex items-center justify-center gap-1
          ${isHovered ? "opacity-0" : "opacity-100"}
        `}
      >
        {showIcon && <Users size={16} />}
        {text}
      </span>

      {/* Container for SVG Icons */}
      <div className="flex w-[200px] rounded-[80px] leading-[50px]">
        {/* Twitter Icon */}
        <svg
          height="35"
          width="35"
          ...
          className={`
            px-1.5 transition-opacity duration-300 ease-in-out
